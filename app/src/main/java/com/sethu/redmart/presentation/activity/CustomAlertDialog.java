...
public class CustomAlertDialog implements DialogClickInterface, DialogInterface.OnClickListener {
    ...
    public void showConfirmDialog(String pTitle, String pMessage,
                                  ...
                                  Context pContext, final int pDialogIdentifier, String imgUrl, String price) {
        ...
        TextView textDialog2 = (TextView) dialog.findViewById(R.id.textDialog2);
        textDialog2.setText(price);

        ImageView imageView = dialog.findViewById(R.id.itemImage);
        Picasso.get().load("http://media.redmart.com/newmedia/200p" + imgUrl).into(imageView);
